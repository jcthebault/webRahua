...
<body>
    ...
    <main class="main_main">
        <div class="botonesSelectores">
            <div class="contenedorFlex">
            <button class="botonSelector" onclick="mostrarInformacionImportante()">Importante</button>
                <button class="botonSelector" onclick="mostrarNovedades()">Novedades</button>
                <button class="botonSelector" onclick="mostrarSorteos()">Sorteos</button>
            </div>
        </div>
        ...
        <div id="contenedorSorteos" style="display: none;">
        ...
        <div id="contenedorInformacionImportante" style="display: none;">
